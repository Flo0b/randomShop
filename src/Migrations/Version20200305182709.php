 ...
 */
final class Version20200305182709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE discount_rules CHANGE discount_percent discount_percent SMALLINT DEFAULT NULL');
        $this->addSql('ALTER TABLE products ADD category_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE discounted_price discounted_price DOUBLE PRECISION DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
